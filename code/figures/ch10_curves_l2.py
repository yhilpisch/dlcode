...
def main() -> None:
    out = Path("figures/ch10_curves_l2.svg")
    ...
    axes[0].plot(e, tr0, label="train")
    axes[0].plot(e, va0, label="val")
    axes[0].set_title("no weight decay")
    axes[0].set_xlabel("epoch")
    axes[0].set_ylabel("loss")
    axes[0].legend(frameon=False)
    axes[1].plot(e, tr1, label="train")
    axes[1].plot(e, va1, label="val")
    axes[1].set_title(f"weight decay {wd:g}")
